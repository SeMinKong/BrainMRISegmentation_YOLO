...
**YOLO11** 아키텍처를 활용하여 뇌 MRI 이미지에서 종양을 **분류(Classification)**하고 **분할(Segmentation)**하는 엔드-투-엔드 의료 영상 파이프라인입니다. 단순한 진단을 넘어, 종양의 유형 파악과 정확한 경계 추출을 하나의 통합된 시스템으로 구현했습니다.
